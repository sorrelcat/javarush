...
public class Archiver {
    ...
    /*BufferedReader reader = new BufferedReader(new InputStreamReader(System.in));
        ...
        ZipFileManager zfm = new ZipFileManager(Paths.get(fullPath));

        System.out.println("Enter file to be archivated");
        String archivatedFilePath = reader.readLine();

        zfm.createZip(Paths.get(archivatedFilePath));
        reader.close();
